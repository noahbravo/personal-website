...
var __toESM = (mod, isNodeMode, target2) => (target2 = mod != null ? __create(__getProtoOf(mod)) : {}, __copyProps(
  isNodeMode || !mod || !mod.__esModule ? __defProp(target2, "default", { value: mod, enumerable: !0 }) : target2,
  mod
...
var import_react = require("@stitches/react"), { styled, css, globalCss, keyframes, getCssText, theme, createTheme, config } = (0, import_react.createStitches)({
  theme: {
    colors: {
...
// app/entry.server.tsx
var import_jsx_dev_runtime = require("react/jsx-dev-runtime"), handleRequest = (request, responseStatusCode, responseHeaders, remixContext) => {
  let markup = (0, import_server.renderToString)(/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(import_react2.RemixServer, {
...
// app/root.tsx
var import_jsx_dev_runtime = require("react/jsx-dev-runtime"), meta2 = () => meta, links2 = () => links, App = () => (globalStyles(), /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("html", {
  lang: "en",
...
var import_node = require("@remix-run/node"), import_react23 = require("@remix-run/react");
...
function getAlbums() {
  return tracks_default.tracks.map(({ album, artists }) => {
    ...
    return {
      ...
      artist: {
        name: artistName,
        image: albumArtist == null ? void 0 : albumArtist.images[2].url
      }
    };
  });
}
...
function getExperience() {
  let today = new Date(), startDate = new Date("05-01-2015"), diff = today.valueOf() - startDate.valueOf(), timeDiff = new Date(diff);
...
function useUserAgent() {
  let [userAgent, setUserAgent] = (0, import_react4.useState)("");
...
var import_react10 = require("react"), import_gsap = __toESM(require("gsap"));
...
var duration = 0.1, ease = "Sine.easeInOut", visible = { duration, autoAlpha: 1, ease }, invisible = { duration, autoAlpha: 0, ease };
function animateMobileMenu(gsap3) {
  function openMenu() {
    gsap3.to(".mobileMenu" /* menu */, {
      ...visible,
      duration: 0.25,
      pointerEvents: "auto",
      x: "0%"
...
var import_react6 = require("react"), useIsomorphicLayoutEffect = typeof window < "u" ? import_react6.useLayoutEffect : import_react6.useEffect;

// app/utils/hooks/useEventListener.ts
function useEventListener(eventName, handler, element, options) {
  let savedHandler = (0, import_react7.useRef)(handler);
  useIsomorphicLayoutEffect(() => {
    savedHandler.current = handler;
  }, [handler]), (0, import_react7.useEffect)(() => {
    let targetElement = (element == null ? void 0 : element.current) ?? window;
...
function useWindowSize() {
  let [windowSize, setWindowSize] = (0, import_react8.useState)({
    width: 0,
    height: 0
  }), handleSize = () => {
    setWindowSize({
...
function useAnimations() {
  let ScrollTrigger = (0, import_react10.useRef)(null), ScrollToPlugin = (0, import_react10.useRef)(null), Draggable = (0, import_react10.useRef)(null), isMounted = useIsMounted(), { width } = useWindowSize(), screenWidths = useScreenWidths();
  return (0, import_react10.useEffect)(() => {
    ScrollTrigger.current = require("gsap/ScrollTrigger").ScrollTrigger, ScrollToPlugin.current = require("gsap/ScrollToPlugin").ScrollToPlugin, Draggable.current = require("gsap/Draggable").Draggable, [ScrollTrigger, ScrollToPlugin, Draggable].forEach((plugin) => {
      plugin != null && plugin.current && import_gsap.default.registerPlugin(plugin.current);
    });
  }, [isMounted]), {
    animateSmoothScroll: (0, import_react10.useCallback)(() => {
      isMounted && animateSmoothScroll(import_gsap.default);
    }, [isMounted]),
    animateMobileMenu: (0, import_react10.useCallback)(() => {
      if (isMounted)
        return animateMobileMenu(import_gsap.default);
    }, [isMounted]),
    animateBgColorOnScroll: (0, import_react10.useCallback)(
      (container) => {
        isMounted && animateBgColorOnScroll(import_gsap.default, container);
      },
      [isMounted]
    ),
    animateAbout: (0, import_react10.useCallback)(() => {
      isMounted && animateAbout(import_gsap.default, screenWidths);
    }, [isMounted, screenWidths]),
    animateStack: (0, import_react10.useCallback)(() => {
      isMounted && animateStack(import_gsap.default);
    }, [isMounted]),
    animateInspiration: (0, import_react10.useCallback)(
      (container) => {
        isMounted && Draggable.current && animateInspiration(import_gsap.default, container, width, screenWidths, Draggable.current);
      },
      [isMounted, width, screenWidths]
    ),
    animateContact: (0, import_react10.useCallback)(() => {
      isMounted && animateContact(import_gsap.default);
    }, [isMounted])
  };
}
...
var createImageInteraction = (cardOptions) => {
  ...
  loadImages(imageURLS, (images) => {
    ...
    }, 2e3), import_gsap2.default.timeline({
      delay: 0.8,
      defaults: {
        duration: 1.5,
        stagger: 0.1,
...
function useCreateImageInteraction() {
  ...
  return { createImageInteraction: (0, import_react11.useCallback)(() => {
...
function useOnPageLoad() {
  let [loaded, setLoaded] = (0, import_react12.useState)(!1);
  return (0, import_react12.useEffect)(() => {
    let onPageLoad = () => {
      setLoaded(!0), document.body.style.setProperty("overflow-y", "auto");
    };
...
function useProgressiveImage(lowQualitySrc, highQualitySrc) {
  let [src, setSrc] = (0, import_react13.useState)(lowQualitySrc || highQualitySrc);
...
var import_jsx_dev_runtime = require("react/jsx-dev-runtime"), List = ({ children, css: css2, ...props }) => {
...
// app/ui/primitives/form/Button/index.tsx
var import_jsx_dev_runtime = require("react/jsx-dev-runtime"), Button = import_react14.default.forwardRef(
...
var import_jsx_dev_runtime = require("react/jsx-dev-runtime"), Box = ({ children, border: border2, css: css2, ...props }) => {
...
var import_jsx_dev_runtime = require("react/jsx-dev-runtime"), Container = import_react15.default.forwardRef(
...
var import_jsx_dev_runtime = require("react/jsx-dev-runtime"), Grid = ({ children, css: css2, ...props }) => {
...
// app/ui/primitives/media/Img/index.tsx
var import_jsx_dev_runtime = require("react/jsx-dev-runtime"), Img = import_react16.default.forwardRef(
...
var import_jsx_dev_runtime = require("react/jsx-dev-runtime"), externalLinkProps = {
...
var import_jsx_dev_runtime = require("react/jsx-dev-runtime"), Text = import_react17.default.forwardRef(({ as = "span", css: css2, variant, children, ...props }, forwardedRef) => {
...
var import_jsx_dev_runtime = require("react/jsx-dev-runtime"), experience = getExperience(), FirstRow = () => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Grid, {
  templateColumns: "12",
  children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Text, {
      ...
      lineHeight: "relaxed",
      children: [
        "Hi, I'm Elena Bravo, a multidisciplinary front-end developer and digital designer based in Madrid, Spain. With over ",
        experience,
...
var import_jsx_dev_runtime = require("react/jsx-dev-runtime"), SecondRow = () => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Grid, {
  templateColumns: "12",
...
var import_jsx_dev_runtime = require("react/jsx-dev-runtime"), ThirdRow = () => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Grid, {
  templateColumns: "12",
...
// app/ui/components/About/index.tsx
var import_jsx_dev_runtime = require("react/jsx-dev-runtime"), About = ({ animateAbout: animateAbout2, createImageInteraction: createImageInteraction2 }) => ((0, import_react18.useEffect)(() => {
  animateAbout2(), createImageInteraction2();
}, [animateAbout2, createImageInteraction2]), /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Container, {
  as: "section",
  id: "about",
  ...
  children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Container, {
    ...
    height: "100%",
    children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(FirstRow_default, {}, void 0, !1, {
        fileName: "app/ui/components/About/index.tsx",
        lineNumber: 19,
        columnNumber: 9
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(SecondRow_default, {}, void 0, !1, {
        fileName: "app/ui/components/About/index.tsx",
        lineNumber: 20,
        columnNumber: 9
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(ThirdRow_default, {}, void 0, !1, {
        fileName: "app/ui/components/About/index.tsx",
        lineNumber: 21,
        columnNumber: 9
      }, this)
...
var import_jsx_dev_runtime = require("react/jsx-dev-runtime"), ContactEmail = () => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(import_jsx_dev_runtime.Fragment, {
  children: [
...
var import_jsx_dev_runtime = require("react/jsx-dev-runtime"), ContactSocial = () => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Grid, {
  templateColumns: "12",
  children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Img, {
...
// app/ui/components/Contact/index.tsx
var import_jsx_dev_runtime = require("react/jsx-dev-runtime"), Contact = ({ animateContact: animateContact2 }) => ((0, import_react19.useEffect)(() => {
  animateContact2();
}, [animateContact2]), /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Container, {
  as: "section",
  id: "contact",
  ...
  children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Container, {
    ...
    maxHeight: 708,
    children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Email_default, {}, void 0, !1, {
        fileName: "app/ui/components/Contact/index.tsx",
        lineNumber: 22,
        columnNumber: 9
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Social_default, {}, void 0, !1, {
        fileName: "app/ui/components/Contact/index.tsx",
        lineNumber: 23,
        columnNumber: 9
      }, this)
...
var import_jsx_dev_runtime = require("react/jsx-dev-runtime"), Album = ({ album, artist }) => {
...
// app/ui/components/Inspiration/index.tsx
var import_jsx_dev_runtime = require("react/jsx-dev-runtime"), albumLimit = 8, Inspiration = ({ albums, animateInspiration: animateInspiration2 }) => {
  let screenWidths = useScreenWidths(), containerRef = (0, import_react20.useRef)(null), renderAlbum = (index) => {
  ...
  return (0, import_react20.useEffect)(() => {
    containerRef != null && containerRef.current && animateInspiration2(containerRef == null ? void 0 : containerRef.current);
  }, [animateInspiration2]), /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Container, {
    as: "section",
    id: "inspiration",
    ref: containerRef,
      ...
      children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Container, {
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Flex, {
            className: "albumList",
            position: "relative",
            children: albums.map((data, index) => renderAlbum(index) ? /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(album_default, {
              ...data
            }, data.id, !1, {
              fileName: "app/ui/components/Inspiration/index.tsx",
              lineNumber: 53,
...
var import_jsx_dev_runtime = require("react/jsx-dev-runtime"), CTA = () => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Link, {
  ...
  lineNumber: 6,
  columnNumber: 3
}, this), CTA_default = CTA;

// app/assets/img/heading.svg
var heading_default = "/build/_assets/heading-EOWW6AIC.svg";

// app/ui/components/Intro/Heading.tsx
var import_jsx_dev_runtime = require("react/jsx-dev-runtime"), Heading = () => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Img, {
  src: heading_default,
  ...
  lineNumber: 6,
  columnNumber: 3
}, this), Heading_default = Heading;

// app/assets/img/arrow.svg
var arrow_default = "/build/_assets/arrow-6HCQ7SNL.svg";

// app/ui/components/Intro/ScrollDown.tsx
var import_jsx_dev_runtime = require("react/jsx-dev-runtime"), ScrollDown = () => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Container, {
  position: "absolute",
  bottom: { xs: 0, lg: 50 },
  width: "100%",
  paddingBottom: 86,
  ...
  lineNumber: 5,
  columnNumber: 3
}, this), ScrollDown_default = ScrollDown;

// app/ui/components/Intro/index.tsx
var import_jsx_dev_runtime = require("react/jsx-dev-runtime"), Intro = () => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Container, {
  width: "100%",
  height: "100vh",
  as: "section",
  children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Container, {
    ...
    children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Flex, {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Grid, {
          ...
          maxHeight: 500,
          children: [
            /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Heading_default, {}, void 0, !1, {
              fileName: "app/ui/components/Intro/index.tsx",
              lineNumber: 12,
              columnNumber: 13
            }, this),
            /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(CTA_default, {}, void 0, !1, {
              fileName: "app/ui/components/Intro/index.tsx",
              lineNumber: 13,
              columnNumber: 13
            }, this)
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(ScrollDown_default, {}, void 0, !1, {
          fileName: "app/ui/components/Intro/index.tsx",
          lineNumber: 15,
          columnNumber: 11
        }, this)
...
var import_jsx_dev_runtime = require("react/jsx-dev-runtime"), Header = () => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Container, {
  as: "header",
...
var import_jsx_dev_runtime = require("react/jsx-dev-runtime"), MenuButton = ({ openMenu, closeMenu }) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(import_jsx_dev_runtime.Fragment, {
  children: [
...
var import_jsx_dev_runtime = require("react/jsx-dev-runtime"), MobileMenu = ({ menuItems: menuItems2, networks, animateMobileMenu: animateMobileMenu2 }) => {
...
var import_jsx_dev_runtime = require("react/jsx-dev-runtime"), DesktopMenu = ({ menuItems: menuItems2 }) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Container, {
  as: "nav",
  display: { xs: "hidden", lg: "flex" },
  position: "fixed",
  bottom: 86,
  ...
  lineNumber: 6,
  columnNumber: 3
}, this), Desktop_default = DesktopMenu;

// app/ui/components/Layout/Menu/index.tsx
var import_jsx_dev_runtime = require("react/jsx-dev-runtime"), menuItems = ["about", "stack", "inspiration", "contact"], Menu = ({ animateMobileMenu: animateMobileMenu2 }) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(import_jsx_dev_runtime.Fragment, {
  children: [
...
var import_jsx_dev_runtime = require("react/jsx-dev-runtime"), year = new Date().getFullYear(), Footer = () => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Container, {
  as: "footer",
  position: "absolute",
  bottom: "0",
  width: "100vw",
...
// app/ui/components/Layout/index.tsx
var import_jsx_dev_runtime = require("react/jsx-dev-runtime"), Layout = ({
  children,
  animateBgColorOnScroll: animateBgColorOnScroll2,
  animateSmoothScroll: animateSmoothScroll2,
  animateMobileMenu: animateMobileMenu2
}) => {
  let containerRef = (0, import_react21.useRef)(null);
  return animateSmoothScroll2(), (0, import_react21.useEffect)(() => {
    containerRef != null && containerRef.current && animateBgColorOnScroll2(containerRef.current);
  }, [animateBgColorOnScroll2]), /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Container, {
    position: "relative",
    children: [
...
var import_jsx_dev_runtime = require("react/jsx-dev-runtime"), Preloader = ({ loaded }) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Container, {
  position: "fixed",
  zIndex: "z60",
...
// app/ui/components/Stack/index.tsx
var import_jsx_dev_runtime = require("react/jsx-dev-runtime"), Stack = ({ animateStack: animateStack2 }) => ((0, import_react22.useEffect)(() => {
  animateStack2();
}, [animateStack2]), /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Container, {
  as: "section",
  className: "section",
  id: "stack",
  paddingY: { xs: 0, lg: 86 },
...
var import_jsx_dev_runtime = require("react/jsx-dev-runtime"), Home = ({
  albums,
  loaded,
  animateBgColorOnScroll: animateBgColorOnScroll2,
  ...
  children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Preloader, {
      loaded
    }, void 0, !1, {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Layout, {
      ...
      animateMobileMenu: animateMobileMenu2,
      children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Intro, {}, void 0, !1, {
          fileName: "app/ui/screens/Home.tsx",
          lineNumber: 29,
          columnNumber: 9
        }, this),
...
var import_jsx_dev_runtime = require("react/jsx-dev-runtime"), loader = async () => {
  ...
  return (0, import_node.json)(albums);
}, Index = () => {
  let albums = (0, import_react23.useLoaderData)(), animations = useAnimations(), loaded = useOnPageLoad(), { createImageInteraction: createImageInteraction2 } = useCreateImageInteraction();
