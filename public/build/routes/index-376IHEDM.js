...
var init_ScrollTrigger = __esm({
  "node_modules/gsap/ScrollTrigger.js"() {
    ...
    _allowNativePanning = function _allowNativePanning2(target, direction2) {
      if (direction2 === true) {
...
function animateAlbums(gsap5, container, width, screenWidths, Draggable2) {
  ...
  gsap5.to(selectors.album, { x: "-200%" });
  albumTl.to(
    selectors.album,
    {
      autoAlpha: 1,
  ...
  Draggable2.create(selectors.album, {
    type: "x,y",
    edgeResistance: 0.65,
    bounds: ".main",
    inertia: true
...
function animateContact(gsap5, ghost) {
  ...
  moveY(ghost, -1);
  rotate(ghost, 1);
  function rotate(target, direction2) {
    gsap5.to(target, randomTime2(), {
  ...
  function moveX(target, direction2) {
    gsap5.to(target, randomTime(), {
  ...
  function moveY(target, direction2) {
    gsap5.to(target, randomTime(), {
...
function useWindowSize() {
  const [windowSize, setWindowSize] = (0, import_react4.useState)({
    width: 0,
    height: 0
  });
  const handleSize = () => {
...
function useAnimations() {
  const ScrollTrigger3 = (0, import_react5.useRef)(null);
  const Draggable2 = (0, import_react5.useRef)(null);
  const isMounted = useIsMounted();
  const { width } = useWindowSize();
  const screenWidths = (0, import_react5.useMemo)(
    () => ({
      phoneOnly: width < 480,
      phoneUp: width >= 480,
      laptopUp: width >= 1024,
  ...
  const animations = {
    animateBgColorOnScroll: (0, import_react5.useCallback)(
      (container) => {
        if (isMounted) {
    ...
    animateAbout: (0, import_react5.useCallback)(() => {
      if (isMounted) {
        animateAbout(gsapWithCSS, screenWidths);
      }
    }, [isMounted, screenWidths]),
    animateStack: (0, import_react5.useCallback)(() => {
      if (isMounted) {
        animateStack(gsapWithCSS);
      }
    }, [isMounted]),
    animateAlbums: (0, import_react5.useCallback)(
      (container) => {
    ...
    animateContact: (0, import_react5.useCallback)(
      (target) => {
        if (isMounted) {
          animateContact(gsapWithCSS, target);
        }
      },
      [isMounted]
    )
...
var import_jsx_dev_runtime = __toESM(require_jsx_dev_runtime());
var Container = import_react7.default.forwardRef(
...
// app/ui/primitives/media/Img/index.tsx
var import_jsx_dev_runtime = __toESM(require_jsx_dev_runtime());
var Img = import_react8.default.forwardRef(
...
var import_jsx_dev_runtime = __toESM(require_jsx_dev_runtime());
var Text = import_react9.default.forwardRef(({ as = "span", css, variant, children, ...props }, forwardedRef) => {
...
// app/ui/components/Contact/Email.tsx
var import_jsx_dev_runtime = __toESM(require_jsx_dev_runtime());
var ContactEmail = import_react11.default.forwardRef((_, ref2) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(import_jsx_dev_runtime.Fragment, {
  children: [
...
function Contact({ animateContact: animateContact2 }) {
  ...
  (0, import_react12.useEffect)(() => {
    if (targetRef.current) {
      animateContact2(targetRef.current);
    }
  }, [animateContact2]);
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Container, {
    as: "section",
    ...
    children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Container, {
      ...
      maxHeight: 708,
      children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Email_default, {
          ref: targetRef
        }, void 0, false, {
 ...
 * @author: Jack Doyle, jack@greensock.com
*/
//# sourceMappingURL=/build/routes/index-376IHEDM.js.map
