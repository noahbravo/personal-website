...
function animateAlbums(gsap6, container, width, screenWidths, Draggable2) {
  ...
  gsap6.to(selectors.album, { x: "-200%" });
  albumTl.to(
    selectors.album,
    {
      autoAlpha: 1,
...
function smoothScroll(gsap6) {
  function closeMenu2() {
    ...
    gsap6.to(".openMenuBtn" /* openBtn */, { autoAlpha: 1 });
    gsap6.to(".closeMenuBtn" /* closeBtn */, { autoAlpha: 0 });
  }
  function openMenu2() {
    gsap6.to(".mobileMenu" /* menu */, {
      duration: 0.5,
    ...
    gsap6.to(".openMenuBtn" /* openBtn */, { autoAlpha: 0 });
    gsap6.to(".closeMenuBtn" /* closeBtn */, { autoAlpha: 1 });
  }
  ...
  return { openMenu: openMenu2, closeMenu: closeMenu2 };
}
...
var import_jsx_dev_runtime = __toESM(require_jsx_dev_runtime());
var MenuButton = ({ openMenu: openMenu2, closeMenu: closeMenu2 }) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(import_jsx_dev_runtime.Fragment, {
  children: [
 ...
 * @author: Jack Doyle, jack@greensock.com
*/
//# sourceMappingURL=/build/routes/index-4QD7I4JX.js.map
