...
var import_jsx_dev_runtime = __toESM(require_jsx_dev_runtime());
var today = new Date();
var startDate = new Date("05/01/2018");
var todayTimeStamp = today.getTime();
var startDataTimeStamp = startDate.getTime();
var diffTime = new Date(startDataTimeStamp - todayTimeStamp);
var years = diffTime.getFullYear();
console.log({ years });
 ...
 * @author: Jack Doyle, jack@greensock.com
*/
//# sourceMappingURL=/build/routes/index-57ESXFTB.js.map
