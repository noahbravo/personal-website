...
function useIsMounted() {
  ...
  const isMounted = (0, import_react.useCallback)(() => isMountedRef.current, []);
...
function useAnimations() {
  ...
  return {
    animateBgColorOnScroll: (0, import_react2.useCallback)(
      (container) => {
        isMounted && animateBgColorOnScroll(gsapWithCSS, container);
      },
      [isMounted]
    )
  };
...
var import_jsx_dev_runtime = __toESM(require_jsx_dev_runtime());
var Text = import_react5.default.forwardRef(({ as = "span", css, variant, children, ...props }, forwardedRef) => {
 ...
 * @author: Jack Doyle, jack@greensock.com
*/
//# sourceMappingURL=/build/routes/index-5BNFWHCU.js.map
