...
function animateAlbums(gsap4, container, width, Draggable) {
  const screenWidths = {
    phoneOnly: width < 480,
    phoneUp: width >= 480,
    laptopUp: width >= 1024,
  ...
  const albumTl = gsap4.timeline({
    scrollTrigger: {
      trigger: selectors.container
    }
  });
  gsap4.to(selectors.album, { x: "-200%" });
  albumTl.to(
    selectors.album,
    {
      autoAlpha: 1,
...
function animateBgColorOnScroll(gsap4, container) {
  const colors3 = {
    turquoise400: "#005C65",
    yellow100: "#FFAD00",
    red100: "#FF0D00"
...
function useAnimations() {
  ...
  const Draggable = (0, import_react5.useRef)(null);
    ...
    animateAlbums: (0, import_react5.useCallback)(
      (container) => {
        if (isMounted && Draggable.current) {
          animateAlbums(gsapWithCSS, container, width, Draggable.current);
        }
      },
      [isMounted, width]
    )
 ...
 * @author: Jack Doyle, jack@greensock.com
*/
//# sourceMappingURL=/build/routes/index-5ORFOEQM.js.map
