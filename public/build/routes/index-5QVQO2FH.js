...
function useAnimations() {
  ...
  const hanldeAnimation = (0, import_react6.useCallback)(
    (animation) => {
      if (isMounted) {
        return animation();
      }
  ...
  const animations = {
    smoothScroll: hanldeAnimation(() => smoothScroll(gsapWithCSS)),
 ...
 * @author: Jack Doyle, jack@greensock.com
*/
//# sourceMappingURL=/build/routes/index-5QVQO2FH.js.map
