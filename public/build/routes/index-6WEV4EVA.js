...
function smoothScroll(gsap6) {
  function closeMenu() {
    ...
    gsap6.to(".openMenuBtn" /* openBtn */, { duration, autoAlpha: 1 });
    gsap6.to(".closeMenuBtn" /* closeBtn */, { duration, autoAlpha: 0 });
  }
  function openMenu() {
    gsap6.to(".mobileMenu" /* menu */, {
      duration,
    ...
    gsap6.to(".openMenuBtn" /* openBtn */, { duration, autoAlpha: 0 });
    gsap6.to(".closeMenuBtn" /* closeBtn */, { duration, autoAlpha: 1 });
  }
...
var import_jsx_dev_runtime = __toESM(require_jsx_dev_runtime());
var MobileMenu = ({ menuItems: menuItems2, networks, smoothScroll: smoothScroll2 }) => {
  const { openMenu, closeMenu } = smoothScroll2() || {};
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Container, {
    position: "fixed",
 ...
 * @author: Jack Doyle, jack@greensock.com
*/
//# sourceMappingURL=/build/routes/index-6WEV4EVA.js.map
