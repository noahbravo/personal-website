...
var require_es_map_constructor = __commonJS({
  "node_modules/core-js/modules/es.map.constructor.js"() {
    ...
    collection("Map", function(init5) {
      return function Map2() {
        return init5(this, arguments.length ? arguments[0] : void 0);
      };
    }, collectionStrong);
  }
});
...
var gsap5, _coreInitted5, _window, _docEl3, _body5, _toArray3, _config2, _windowExists9, _getGSAP7, _isString5, _isFunction7, _max, _buildGetter, _clean, _getOffset, _parseVal, _initCore7, ScrollToPlugin;
var init_ScrollToPlugin = __esm({
  "node_modules/gsap/ScrollToPlugin.js"() {
    ...
    _initCore7 = function _initCore8() {
      gsap5 = _getGSAP7();
      if (_windowExists9() && gsap5 && document.body) {
        _window = window;
    ...
    _getGSAP7() && gsap5.registerPlugin(ScrollToPlugin);
  }
});
...
function smoothScrollbar(scroller, ScrollTrigger3) {
  ...
  ScrollTrigger3.scrollerProxy(".scroller", {
    scrollTop(value) {
      if (arguments.length) {
  ...
  document.querySelectorAll('a[href^="#"]').forEach((anchor) => {
    anchor.addEventListener("click", function(e) {
      e.preventDefault();
      const scrollToHere = document.querySelector(this.getAttribute("href")).offsetTop;
      bodyScrollBar.scrollTo(0, scrollToHere, 1e3);
    });
  });
  const menuItemsSelector = ".menuLink";
...
***************************************************************************** */
//# sourceMappingURL=/build/routes/index-7HIZDANJ.js.map
