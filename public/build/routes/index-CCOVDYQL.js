...
function animateBgColorOnScroll(gsap6, container) {
  ...
  gsap6.to(container, { backgroundColor: "#0098a8" /* turquoise200 */ });
  const tl = gsap6.timeline({
    scrollTrigger: {
      scrub: true,
...
function useAnimations() {
  const ScrollTrigger3 = (0, import_react7.useRef)(null);
  const ScrollToPlugin2 = (0, import_react7.useRef)(null);
  const Draggable2 = (0, import_react7.useRef)(null);
  ...
  const animations = {
    animateSmoothScroll: (0, import_react7.useCallback)(() => {
      if (isMounted) {
        animateSmoothScroll(gsapWithCSS);
      }
    }, [isMounted]),
    animateMobileMenu: (0, import_react7.useCallback)(() => {
      if (isMounted) {
        return animateMobileMenu(gsapWithCSS);
      }
    }, [isMounted]),
    animateBgColorOnScroll: (0, import_react7.useCallback)(
      (container) => {
        if (isMounted) {
    ...
    animateAbout: (0, import_react7.useCallback)(() => {
      if (isMounted) {
        animateAbout(gsapWithCSS, screenWidths);
      }
    }, [isMounted, screenWidths]),
    animateStack: (0, import_react7.useCallback)(() => {
      if (isMounted) {
        animateStack(gsapWithCSS);
      }
    }, [isMounted]),
    animateInspiration: (0, import_react7.useCallback)(
      (container) => {
    ...
    animateContact: (0, import_react7.useCallback)(() => {
      if (isMounted) {
...
function useCreateImageInteraction() {
  ...
  const createImageInteractionCb = (0, import_react8.useCallback)(() => {
...
function useProgressiveImage(lowQualitySrc, highQualitySrc) {
  const [src, setSrc] = (0, import_react10.useState)(lowQualitySrc || highQualitySrc);
...
// app/ui/primitives/form/Button/index.tsx
var import_jsx_dev_runtime = __toESM(require_jsx_dev_runtime());
var Button = import_react11.default.forwardRef(
...
var import_jsx_dev_runtime = __toESM(require_jsx_dev_runtime());
var Container = import_react12.default.forwardRef(
...
// app/ui/primitives/media/Img/index.tsx
var import_jsx_dev_runtime = __toESM(require_jsx_dev_runtime());
var Img = import_react13.default.forwardRef(
...
var import_jsx_dev_runtime = __toESM(require_jsx_dev_runtime());
var Text = import_react14.default.forwardRef(({ as = "span", css, variant, children, ...props }, forwardedRef) => {
      ...
      children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Container, {
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Flex, {
            className: "albumList",
            position: "relative",
            children: albums.map((data, index) => {
              return renderAlbum(index) ? /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(album_default, {
                ...data
              }, data.id, false, {
                fileName: "app/ui/components/Inspiration/index.tsx",
                lineNumber: 53,
...
var import_jsx_dev_runtime = __toESM(require_jsx_dev_runtime());
var Preloader = ({ loaded }) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Container, {
  position: "fixed",
  zIndex: "z60",
 ...
 * @author: Jack Doyle, jack@greensock.com
*/
//# sourceMappingURL=/build/routes/index-CCOVDYQL.js.map
