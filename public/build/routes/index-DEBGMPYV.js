...
function smoothScrollbar(scroller, ScrollTrigger3, ScrollSmoother) {
...
function useAnimations() {
  ...
  const ScrollSmoother = (0, import_react6.useRef)(null);
  ...
  const animations = {
    smoothScrollbar: (0, import_react6.useCallback)(
      (scroller) => {
        if (isMounted) {
          smoothScrollbar(scroller, ScrollTrigger3.current, ScrollSmoother.current);
        }
      },
      [isMounted]
    ),
 ...
 * @author: Jack Doyle, jack@greensock.com
*/
//# sourceMappingURL=/build/routes/index-DEBGMPYV.js.map
