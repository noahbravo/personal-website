...
var gsap5, _coreInitted4, _window, _docEl3, _body3, _toArray2, _config2, _windowExists7, _getGSAP5, _isString5, _isFunction5, _max, _buildGetter, _clean, _getOffset, _parseVal, _initCore5, ScrollToPlugin;
var init_ScrollToPlugin = __esm({
  "node_modules/gsap/ScrollToPlugin.js"() {
    ...
    _initCore5 = function _initCore6() {
      gsap5 = _getGSAP5();
      if (_windowExists7() && gsap5 && document.body) {
        _window = window;
    ...
    ScrollToPlugin = {
      ...
      init: function init4(target2, value, tween, index, targets) {
        ...
        var data = this, snapType = gsap5.getProperty(target2, "scrollSnapType");
        ...
        gsap5.getProperty(target2, "scrollBehavior") === "smooth" && gsap5.set(target2, {
          scrollBehavior: "auto"
        });
    ...
    Draggable = /* @__PURE__ */ function(_EventDispatcher) {
      ...
      function Draggable2(target2, vars) {
        ...
        var type = (vars.type || "x,y").toLowerCase(), xyMode = ~type.indexOf("x") || ~type.indexOf("y"), rotationMode = type.indexOf("rotation") !== -1, xProp = rotationMode ? "rotation" : xyMode ? "x" : "left", yProp = xyMode ? "y" : "top", allowX = !!(~type.indexOf("x") || ~type.indexOf("left") || type === "scroll"), allowY = !!(~type.indexOf("y") || ~type.indexOf("top") || type === "scroll"), minimumMovement = vars.minimumMovement || 2, self = _assertThisInitialized2(_this2), triggers = _toArray3(vars.trigger || vars.handle || target2), killProps = {}, dragEndTime = 0, checkAutoScrollBounds = false, autoScrollMarginTop = vars.autoScrollMarginTop || 40, autoScrollMarginRight = vars.autoScrollMarginRight || 40, autoScrollMarginBottom = vars.autoScrollMarginBottom || 40, autoScrollMarginLeft = vars.autoScrollMarginLeft || 40, isClickable = vars.clickableTest || _isClickable, clickTime = 0, gsCache = target2._gsap || gsap6.core.getCache(target2), isFixed = _isFixed3(target2), getPropAsNum = function getPropAsNum2(property, unit) {
          ...
          if (!target2._gsap) {
            gsCache = gsap6.core.getCache(target2);
          }
          gsCache.uncache && gsap6.getProperty(target2, "x");
          if (xyMode) {
          ...
          if (inertia && InertiaPlugin) {
            ...
            self.tween = tween = gsap6.to(scrollProxy || target2, {
              inertia,
              data: "_draggable",
          ...
          self.isThrowing = false;
          gsap6.killTweensOf(scrollProxy || target2, killProps, true);
          scrollProxy && gsap6.killTweensOf(target2, {
            scrollTo: 1
          }, true);
...
function smoothScroll() {
  document.querySelectorAll('a[href^="#"]').forEach((link) => {
    console.log({ link, test: link.getAttribute("href") });
 ...
 * @author: Jack Doyle, jack@greensock.com
*/
//# sourceMappingURL=/build/routes/index-DLBB432A.js.map
