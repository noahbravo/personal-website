...
function useWindowSize() {
  const [windowSize, setWindowSize] = (0, import_react3.useState)({
    width: 0,
    height: 0
  });
  const handleSize = () => {
...
function useAnimations() {
  const ScrollTrigger3 = (0, import_react4.useRef)(null);
  const Draggable2 = (0, import_react4.useRef)(null);
  ...
  const animations = {
    animateBgColorOnScroll: (0, import_react4.useCallback)(
      (container) => {
        if (isMounted) {
    ...
    animateAlbums: (0, import_react4.useCallback)(
      (container) => {
...
var import_jsx_dev_runtime = __toESM(require_jsx_dev_runtime());
var Text = import_react7.default.forwardRef(({ as = "span", css, variant, children, ...props }, forwardedRef) => {
 ...
 * @author: Jack Doyle, jack@greensock.com
*/
//# sourceMappingURL=/build/routes/index-F7SIK6BU.js.map
