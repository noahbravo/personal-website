...
var import_jsx_dev_runtime = __toESM(require_jsx_dev_runtime());
var MenuButton = ({ display: display2, openMenu, closeMenu }) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(import_jsx_dev_runtime.Fragment, {
  children: [
...
var MobileMenu = ({ menuItems: menuItems2, networks }) => {
  ...
  const openMenu = () => {
    setShowMenu(true);
    gsapWithCSS.to(".mobileMenu", { duration: 0.5, autoAlpha: 1 });
  };
  const closeMenu = () => {
    setShowMenu(false);
    gsapWithCSS.to(".mobileMenu", { duration: 0.5, autoAlpha: 0 });
  };
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Container, {
    position: "fixed",
 ...
 * @author: Jack Doyle, jack@greensock.com
*/
//# sourceMappingURL=/build/routes/index-GGSMHV4I.js.map
