...
function splitProps(props, stylePropsKeys) {
  ...
  Object.entries(props).forEach(([key, value]) => {
    if (stylePropsKeys.includes(key))
      styleProps6[key] = value;
    else
      restProps[key] = value;
  });
  return [styleProps6, restProps];
}
...
function getformattedProps({ props, styleProps: styleProps6, styleAliases: styleAliases6 }) {
  const stylePropsKeys = [
    ...styleProps6 ? Object.keys(styleProps6) : [],
...
//# sourceMappingURL=/build/routes/index-GU4VP5CZ.js.map
