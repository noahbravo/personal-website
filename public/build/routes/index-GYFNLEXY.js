...
var import_jsx_dev_runtime = __toESM(require_jsx_dev_runtime());
function MobileMenu({ menuItems: menuItems2, networks }) {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Container, {
    position: "fixed",
...
var import_jsx_dev_runtime = __toESM(require_jsx_dev_runtime());
function DesktopMenu({ menuItems: menuItems2, networks }) {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Container, {
    as: "nav",
    display: { xs: "hidden", lg: "flex" },
    position: "fixed",
 ...
 * @author: Jack Doyle, jack@greensock.com
*/
//# sourceMappingURL=/build/routes/index-GYFNLEXY.js.map
