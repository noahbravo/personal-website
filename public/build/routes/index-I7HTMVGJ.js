...
function useAnimations() {
  ...
  (0, import_react5.useEffect)(() => {
    ...
    Draggable2.current = (init_Draggable(), __toCommonJS(Draggable_exports));
    gsapWithCSS.registerPlugin(ScrollTrigger3);
    gsapWithCSS.registerPlugin(Draggable2);
  }, []);
  const animations = {
    ...
    animateAlbums: (0, import_react5.useCallback)(
      (container) => {
        if (isMounted && (Draggable2 == null ? void 0 : Draggable2.current)) {
 ...
 * @author: Jack Doyle, jack@greensock.com
*/
//# sourceMappingURL=/build/routes/index-I7HTMVGJ.js.map
