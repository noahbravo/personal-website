...
var gsap2, _coreInitted2, _clamp3, _win3, _doc3, _docEl, _body, _isTouch, _pointerType, ScrollTrigger2, _root, _normalizer, _eventTypes, _getGSAP, _startup, _observers, _scrollers, _proxies, _getTime, _bridge, _integrate, _getProxyProp, _isViewport, _addListener, _removeListener, _scrollLeft, _scrollTop, _onScroll, _scrollCacheFunc, _horizontal, _vertical, _getTarget, _getScrollFunc, _getVelocityProp, _getEvent, _getAbsoluteMax, _setScrollTrigger, _initCore3, Observer;
...
var init_ScrollTrigger = __esm({
  "node_modules/gsap/ScrollTrigger.js"() {
    ...
    ScrollTrigger3 = /* @__PURE__ */ function() {
      ...
      ScrollTrigger4.defaults = function defaults2(config4) {
        if (config4) {
      ...
      ScrollTrigger4.config = function config4(vars) {
      ...
      ScrollTrigger4.scrollerProxy = function scrollerProxy(target2, vars) {
    ...
    ScrollTrigger3.revert = function(soft, media2) {
    ...
    ScrollTrigger3.update = _updateAll;
    ...
    ScrollTrigger3.batch = function(targets, vars) {
      ...
      _toArray(targets).forEach(function(target2) {
        ...
        result.push(ScrollTrigger3.create(config4));
      });
      return result;
    };
...
function smoothScrollbar2(scroller) {
...
function useAnimations() {
  const ScrollTrigger4 = (0, import_react6.useRef)(null);
  ...
  (0, import_react6.useEffect)(() => {
    ScrollTrigger4.current = (init_ScrollTrigger(), __toCommonJS(ScrollTrigger_exports));
    Draggable2.current = (init_Draggable(), __toCommonJS(Draggable_exports)).Draggable;
    const plugins = [ScrollTrigger4, Draggable2];
...
// app/ui/components/Layout/index.tsx
var import_jsx_dev_runtime = __toESM(require_jsx_dev_runtime());
var Layout = ({ children, animateBgColorOnScroll: animateBgColorOnScroll2, smoothScrollbar: smoothScrollbar3 }) => {
  ...
  (0, import_react16.useEffect)(() => {
    ...
    if (scrollerRef == null ? void 0 : scrollerRef.current) {
      smoothScrollbar3(scrollerRef.current);
    }
  }, [animateBgColorOnScroll2, smoothScrollbar3]);
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Container, {
    position: "relative",
...
***************************************************************************** */
//# sourceMappingURL=/build/routes/index-IMYYQI6J.js.map
