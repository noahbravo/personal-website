    ...
    Observer = /* @__PURE__ */ function() {
      ...
      _proto.init = function init5(vars) {
        ...
        var id, onStopDelayedCall, dragged, moved, wheeled, locked, axis, self = this, prevDeltaX = 0, prevDeltaY = 0, scrollFuncX = _getScrollFunc(target2, _horizontal), scrollFuncY = _getScrollFunc(target2, _vertical), scrollX = scrollFuncX(), scrollY = scrollFuncY(), limitToTouch = ~type.indexOf("touch") && !~type.indexOf("pointer") && _eventTypes[0] === "pointerdown", isViewport = _isViewport(target2), ownerDoc = target2.ownerDocument || _doc3, deltaX = [0, 0, 0], deltaY = [0, 0, 0], onClickTime = 0, clickCapture = function clickCapture2() {
          ...
          var multiplier = (e2.deltaMode === 1 ? lineHeight2 : e2.deltaMode === 2 ? _win3.innerHeight : 1) * wheelSpeed;
...
var init_ScrollTrigger = __esm({
  "node_modules/gsap/ScrollTrigger.js"() {
    ...
    _createMarker = function _createMarker2(type, name, container, direction2, _ref4, offset, matchWidthEl, containerAnimation) {
      ...
      e2._offset = e2["offset" + direction2.op.d2];
      _positionMarker(e2, 0, direction2, isStart);
      return e2;
    };
    ...
    _buildGetter = function _buildGetter2(e2, axis) {
      ...
      if (e2 === _window) {
        if (e2.pageXOffset != null) {
          ...
          e2 = _docEl3[p] != null ? _docEl3 : _body3;
        }
      }
      return function() {
        return e2[p];
...
var init_Draggable = __esm({
  "node_modules/gsap/Draggable.js"() {
    ...
    _createElement3 = function _createElement4(type, ns) {
      var e2 = _doc6.createElementNS ? _doc6.createElementNS((ns || "http://www.w3.org/1999/xhtml").replace(/^https/, "http"), type) : _doc6.createElement(type);
      return e2.style ? e2 : _doc6.createElement(type);
    };
    ...
    _addScrollListener = function _addScrollListener2(e2, callback) {
      _addListener5(e2, "scroll", callback);
    ...
    _removeScrollListener = function _removeScrollListener2(e2, callback) {
      _removeListener5(e2, "scroll", callback);
      if (!_isRoot(e2.parentNode)) {
        _removeScrollListener2(e2.parentNode, callback);
      }
    };
    _isRoot = function _isRoot2(e2) {
      return !!(!e2 || e2 === _docElement3 || e2.nodeType === 9 || e2 === _doc6.body || e2 === _win6 || !e2.nodeType || !e2.parentNode);
    };
    ...
    _tempRect = {};
    _parseRect = function _parseRect2(e2) {
      if (e2 === _win6) {
        _tempRect.left = _tempRect.top = 0;
        _tempRect.width = _tempRect.right = _docElement3.clientWidth || e2.innerWidth || _body5.clientWidth || 0;
        _tempRect.height = _tempRect.bottom = (e2.innerHeight || 0) - 20 < _docElement3.clientHeight ? _docElement3.clientHeight : e2.innerHeight || _body5.clientHeight || 0;
        return _tempRect;
      }
      var doc = e2.ownerDocument || _doc6, r = !_isUndefined3(e2.pageX) ? {
    ...
    _getBounds3 = function _getBounds4(target2, context3) {
      var e2 = _toArray3(target2)[0], top, left, offset;
      if (!e2.nodeType && e2 !== _win6) {
      ...
      function Draggable2(target2, vars) {
        ...
        var type = (vars.type || "x,y").toLowerCase(), xyMode = ~type.indexOf("x") || ~type.indexOf("y"), rotationMode = type.indexOf("rotation") !== -1, xProp = rotationMode ? "rotation" : xyMode ? "x" : "left", yProp = xyMode ? "y" : "top", allowX = !!(~type.indexOf("x") || ~type.indexOf("left") || type === "scroll"), allowY = !!(~type.indexOf("y") || ~type.indexOf("top") || type === "scroll"), minimumMovement = vars.minimumMovement || 2, self = _assertThisInitialized2(_this2), triggers = _toArray3(vars.trigger || vars.handle || target2), killProps = {}, dragEndTime = 0, checkAutoScrollBounds = false, autoScrollMarginTop = vars.autoScrollMarginTop || 40, autoScrollMarginRight = vars.autoScrollMarginRight || 40, autoScrollMarginBottom = vars.autoScrollMarginBottom || 40, autoScrollMarginLeft = vars.autoScrollMarginLeft || 40, isClickable = vars.clickableTest || _isClickable, clickTime = 0, gsCache = target2._gsap || gsap5.core.getCache(target2), isFixed = _isFixed3(target2), getPropAsNum = function getPropAsNum2(property, unit) {
          ...
          if (self.autoScroll && self.isDragging && (checkAutoScrollBounds || dirty)) {
            var e2 = target2, autoScrollFactor = self.autoScroll * 15, parent, isRoot, rect, pointerX, pointerY, changeX, changeY, gap;
          ...
          var i;
          if (!enabled || self.isPressed || !e2 || (e2.type === "mousedown" || e2.type === "pointerdown") && !force && _getTime3() - clickTime < 30 && _touchEventLookup[self.pointerEvent.type]) {
          ...
          if (!_supportsPointer || !touchEventTarget) {
            ...
            e2 && e2.target && _addListener5(e2.target, "mouseup", onRelease);
          }
          isClicking = isClickable.call(self, e2.target) && vars.dragClickables === false && !force;
          if (isClicking) {
            _addListener5(e2.target, "change", onRelease);
          ...
          if (touches) {
            ...
            if (e2 !== touch && e2.identifier !== touchID) {
              i = touches.length;
              while (--i > -1 && (e2 = touches[i]).identifier !== touchID && e2.target !== target2) {
              }
              if (i < 0) {
                return;
              }
          ...
          if (!enabled || !self.isPressed || e2 && touchID != null && !force && (e2.pointerId && e2.pointerId !== touchID && e2.target !== target2 || e2.changedTouches && !_hasTouchID(e2.changedTouches, touchID))) {
            isPreventingDefault && e2 && enabled && _preventDefault(e2);
            return;
          }
          self.isPressed = false;
          var originalEvent = e2, wasDragging = self.isDragging, isContextMenuRelease = self.vars.allowContextMenu && e2 && (e2.ctrlKey || e2.which > 2), placeholderDelayedCall = gsap5.delayedCall(1e-3, removePlaceholder), touches, i, syntheticEvent, eventTarget, syntheticClick;
          if (touchEventTarget) {
          ...
          if (!_supportsPointer || !touchEventTarget) {
            ...
            e2 && e2.target && _removeListener5(e2.target, "mouseup", onRelease2);
          }
          dirty = false;
          if (wasDragging) {
          ...
          if (isClicking && !isContextMenuRelease) {
            if (e2) {
              _removeListener5(e2.target, "change", onRelease2);
          ...
          if (e2 && self.isDragging && !scrollProxy) {
            var parent = e2.target || target2.parentNode, deltaX = parent.scrollLeft - parent._gsScrollX, deltaY = parent.scrollTop - parent._gsScrollY;
            if (deltaX || deltaY) {
              if (matrix) {
          ...
          var time = _getTime3(), recentlyClicked = time - clickTime < 100, recentlyDragged = time - dragEndTime < 50, alreadyDispatched = recentlyClicked && clickDispatch === clickTime, defaultPrevented = self.pointerEvent && self.pointerEvent.defaultPrevented, alreadyDispatchedTrusted = recentlyClicked && trustedClickDispatch === clickTime, trusted = e2.isTrusted || e2.isTrusted == null && recentlyClicked && alreadyDispatched;
...
function animateAlbums(gsap6, container, width, screenWidths, Draggable2) {
  ...
  const albumTl = gsap6.timeline({
    scrollTrigger: {
      trigger: selectors2.container
    }
  });
  gsap6.to(selectors2.album, { x: "-200%" });
  albumTl.to(
    selectors2.album,
    {
      autoAlpha: 1,
...
var Canvas = class {
  ...
  initEvents() {
    ...
    const onMouseMove = (e2) => {
      if (this.mouse != null) {
        this.mouse.position.x = e2.offsetX;
        this.mouse.position.y = e2.offsetY;
      }
    };
 ...
 * @author: Jack Doyle, jack@greensock.com
*/
//# sourceMappingURL=/build/routes/index-JFZ7RWGH.js.map
