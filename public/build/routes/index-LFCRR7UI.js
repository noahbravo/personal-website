...
function useAnimations() {
  ...
  const animateBgColorOnScroll2 = (0, import_react.useCallback)(
    (container) => {
      mounted && animateBgColorOnScroll(gsapWithCSS, container);
    },
    [mounted]
  );
  return {
    animateBgColorOnScroll: (0, import_react.useCallback)(
      () => (container) => mounted && animateBgColorOnScroll(gsapWithCSS)(container),
      [mounted]
    )
  };
}
...
var Layout = ({ children, animateBgColorOnScroll: animateBgColorOnScroll2 }) => {
  const mainContainer = (0, import_react5.useRef)(null);
 ...
 * @author: Jack Doyle, jack@greensock.com
*/
//# sourceMappingURL=/build/routes/index-LFCRR7UI.js.map
