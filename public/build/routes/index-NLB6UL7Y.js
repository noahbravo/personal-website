      ...
      function Draggable2(target2, vars) {
        ...
        var type = (vars.type || "x,y").toLowerCase(), xyMode = ~type.indexOf("x") || ~type.indexOf("y"), rotationMode = type.indexOf("rotation") !== -1, xProp = rotationMode ? "rotation" : xyMode ? "x" : "left", yProp = xyMode ? "y" : "top", allowX = !!(~type.indexOf("x") || ~type.indexOf("left") || type === "scroll"), allowY = !!(~type.indexOf("y") || ~type.indexOf("top") || type === "scroll"), minimumMovement = vars.minimumMovement || 2, self = _assertThisInitialized2(_this2), triggers = _toArray2(vars.trigger || vars.handle || target2), killProps = {}, dragEndTime = 0, checkAutoScrollBounds = false, autoScrollMarginTop = vars.autoScrollMarginTop || 40, autoScrollMarginRight = vars.autoScrollMarginRight || 40, autoScrollMarginBottom = vars.autoScrollMarginBottom || 40, autoScrollMarginLeft = vars.autoScrollMarginLeft || 40, isClickable = vars.clickableTest || _isClickable, clickTime = 0, gsCache = target2._gsap || gsap4.core.getCache(target2), isFixed = _isFixed3(target2), getPropAsNum = function getPropAsNum2(property, unit) {
          ...
          if (inertia && InertiaPlugin) {
            ...
            self.tween = tween = gsap4.to(scrollProxy || target2, {
              inertia,
              data: "_draggable",
...
// app/utils/helpers/animations/about.ts
var selectors = {
...
// app/utils/helpers/animations/albums.ts
var selectors2 = {
  container: ".albumList",
  album: ".album"
};
...
// app/utils/helpers/animations/contact.ts
var target = ".ghost";
function animateContact(gsap5) {
  ...
  moveY(-1);
  rotate(1);
  function rotate(direction2) {
    gsap5.to(target, {
      duration: randomTime2(),
      rotation: randomAngle(direction2),
      ease: "Sine.easeInOut",
      onComplete: rotate,
      onCompleteParams: [target, direction2 * -1]
    });
  }
  function moveX(direction2) {
    gsap5.to(target, {
      duration: randomTime(),
...
// app/utils/helpers/animations/stack.ts
var selectors3 = {
  container: "#stack",
  skelly: ".skelly"
};
...
// app/utils/helpers/canvas-image-interaction/lib/utils.js
...
// app/utils/helpers/canvas-image-interaction/lib/particle.js
var Particle = class {
  constructor(options = {}) {
...
// app/utils/helpers/canvas-image-interaction/lib/particles.js
var Particles = class {
  constructor(options = {}) {
    this.ctx = options.ctx;
...
// app/utils/helpers/canvas-image-interaction/lib/canvas.js
var Canvas = class {
  constructor(options = {}) {
...
// app/utils/helpers/canvas-image-interaction/index.ts
var createImageInteraction2 = (cardOptions) => {
...
function useAnimations() {
  ...
  (0, import_react6.useEffect)(() => {
    ScrollTrigger3.current = (init_ScrollTrigger(), __toCommonJS(ScrollTrigger_exports));
...
// app/ui/primitives/form/Button/index.tsx
var import_jsx_dev_runtime = __toESM(require_jsx_dev_runtime());
var Button = import_react8.default.forwardRef(
...
// app/ui/primitives/media/Img/index.tsx
var import_jsx_dev_runtime = __toESM(require_jsx_dev_runtime());
var Img = import_react10.default.forwardRef(
  ({ src, alt, loading = "lazy", width, height, css, ...props }, ref2) => {
    const { mediaStyles, restProps } = getformattedProps({
...
var import_jsx_dev_runtime = __toESM(require_jsx_dev_runtime());
var Text = import_react11.default.forwardRef(({ as = "span", css, variant, children, ...props }, forwardedRef) => {
...
// app/ui/components/About/index.tsx
var import_jsx_dev_runtime = __toESM(require_jsx_dev_runtime());
function About({ animateAbout: animateAbout2, createImageInteraction: createImageInteraction3 }) {
  (0, import_react12.useEffect)(() => {
    animateAbout2();
    createImageInteraction3();
  }, [animateAbout2, createImageInteraction3]);
...
// app/ui/components/Contact/index.tsx
var import_jsx_dev_runtime = __toESM(require_jsx_dev_runtime());
function Contact({ animateContact: animateContact2 }) {
...
// app/ui/components/Inspiration/index.tsx
var import_jsx_dev_runtime = __toESM(require_jsx_dev_runtime());
function Inspiration({ albums, animateAlbums: animateAlbums2 }) {
...
// app/ui/components/Layout/index.tsx
var import_jsx_dev_runtime = __toESM(require_jsx_dev_runtime());
var Layout = ({ children, animateBgColorOnScroll: animateBgColorOnScroll2 }) => {
  const containerRef = (0, import_react15.useRef)(null);
  (0, import_react15.useEffect)(() => {
    if (containerRef == null ? void 0 : containerRef.current) {
      console.log({ animateBgColorOnScroll: animateBgColorOnScroll2 });
      animateBgColorOnScroll2(containerRef == null ? void 0 : containerRef.current);
    }
...
// app/ui/components/Stack/index.tsx
var import_jsx_dev_runtime = __toESM(require_jsx_dev_runtime());
function Stack({ animateStack: animateStack2 }) {
...
function Index() {
  ...
  const { createImageInteraction: createImageInteraction3 } = useCreateImageInteraction();
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Home, {
    albums,
    ...animations,
    createImageInteraction: createImageInteraction3
  }, void 0, false, {
 ...
 * @author: Jack Doyle, jack@greensock.com
*/
//# sourceMappingURL=/build/routes/index-NLB6UL7Y.js.map
