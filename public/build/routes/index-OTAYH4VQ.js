...
var init_Draggable = __esm({
  "node_modules/gsap/Draggable.js"() {
    ...
    Draggable2 = /* @__PURE__ */ function(_EventDispatcher) {
      _inheritsLoose2(Draggable3, _EventDispatcher);
      function Draggable3(target, vars) {
        ...
        _this2.hitTest = function(target2, threshold) {
          return Draggable3.hitTest(self.target, target2, threshold);
        };
    ...
    _setDefaults5(Draggable2.prototype, {
      pointerX: 0,
      pointerY: 0,
      startX: 0,
      startY: 0,
    ...
    Draggable2.version = "3.11.3";
    _getGSAP5() && gsap4.registerPlugin(Draggable2);
  }
});

// app/utils/helpers/animations/albums.ts
function animateAlbums(gsap5, container, width) {
  const screenWidths = {
    phoneOnly: width < 480,
    phoneUp: width >= 480,
    laptopUp: width >= 1024,
...
var _formatColors = function _formatColors2(s, toHSL, orderMatchData) {
  ...
  colors3 = colors3.map(function(color) {
...
function useAnimations() {
  ...
  (0, import_react5.useEffect)(() => {
    const ScrollTrigger3 = (init_ScrollTrigger(), __toCommonJS(ScrollTrigger_exports));
    const Draggable3 = (init_Draggable(), __toCommonJS(Draggable_exports));
    gsapWithCSS.registerPlugin(ScrollTrigger3);
    gsapWithCSS.registerPlugin(Draggable3);
  }, []);
  const animations = {
    ...
    animateAlbums: (0, import_react5.useCallback)(
      (container) => {
        if (isMounted) {
          animateAlbums(gsapWithCSS, container, width);
        }
      },
      [isMounted, width]
    )
...
var import_jsx_dev_runtime = __toESM(require_jsx_dev_runtime());
function Intro({ animateAlbums: animateAlbums2 }) {
  animateAlbums2();
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Container, {
    width: "100%",
    height: "100vh",
...
var Layout = ({ children, animateBgColorOnScroll: animateBgColorOnScroll2 }) => {
  const mainContainer = (0, import_react9.useRef)(null);
  (0, import_react9.useEffect)(() => {
    if (mainContainer == null ? void 0 : mainContainer.current) {
      console.log({ animateBgColorOnScroll: animateBgColorOnScroll2 });
      animateBgColorOnScroll2(mainContainer == null ? void 0 : mainContainer.current);
    }
...
var import_jsx_dev_runtime = __toESM(require_jsx_dev_runtime());
var Home = ({ albums, animateBgColorOnScroll: animateBgColorOnScroll2, animateAlbums: animateAlbums2 }) => {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Layout, {
    animateBgColorOnScroll: animateBgColorOnScroll2,
    children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Intro, {
 ...
 * @author: Jack Doyle, jack@greensock.com
*/
//# sourceMappingURL=/build/routes/index-OTAYH4VQ.js.map
