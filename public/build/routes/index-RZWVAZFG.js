...
function useOnPageLoad() {
  const [loaded2, setLoaded] = (0, import_react9.useState)(false);
...
var import_jsx_dev_runtime = __toESM(require_jsx_dev_runtime());
var Preloader = ({ loaded: loaded2 }) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Container, {
  className: "content",
  position: "relative",
  zIndex: "z60",
  width: "100vw",
  height: "100vh",
  display: loaded2 ? "hidden" : "block",
  children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Flex, {
    direction: "col",
    justify: "center",
    width: "100%",
 ...
 * @author: Jack Doyle, jack@greensock.com
*/
//# sourceMappingURL=/build/routes/index-RZWVAZFG.js.map
