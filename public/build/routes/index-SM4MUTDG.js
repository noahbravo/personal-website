...
function useAnimations() {
  ...
  const animations = {
    smoothScroll: (0, import_react6.useCallback)(() => {
      if (isMounted) {
        return smoothScroll(gsapWithCSS);
      }
    }, [isMounted]),
...
var Menu = ({ smoothScroll: smoothScroll2 }) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(import_jsx_dev_runtime.Fragment, {
  children: [
 ...
 * @author: Jack Doyle, jack@greensock.com
*/
//# sourceMappingURL=/build/routes/index-SM4MUTDG.js.map
