...
function animateAlbums(gsap5, container, width, Draggable2) {
  const screenWidths = {
    phoneOnly: width < 480,
    phoneUp: width >= 480,
    laptopUp: width >= 1024,
...
function useAnimations() {
  ...
  (0, import_react5.useEffect)(() => {
    ...
    const { Draggable: Draggable22 } = (init_Draggable(), __toCommonJS(Draggable_exports));
    Draggable2.current = Draggable22;
    ScrollTrigger3.current && gsapWithCSS.registerPlugin(ScrollTrigger3.current);
    Draggable2.current && gsapWithCSS.registerPlugin(Draggable2.current);
  }, [isMounted]);
  const animations = {
    ...
    animateAlbums: (0, import_react5.useCallback)(
      (container) => {
        if (isMounted && Draggable2.current) {
          animateAlbums(gsapWithCSS, container, width, Draggable2.current);
        }
      },
      [isMounted, width]
    )
 ...
 * @author: Jack Doyle, jack@greensock.com
*/
//# sourceMappingURL=/build/routes/index-TDEHRZYK.js.map
