...
var gsap3, _coreInitted2, _clamp3, _win3, _doc3, _docEl, _body, _isTouch, _pointerType, ScrollTrigger, _root, _normalizer, _eventTypes, _getGSAP, _startup, _observers, _scrollers, _proxies, _getTime, _bridge, _integrate, _getProxyProp, _isViewport, _addListener, _removeListener, _scrollLeft, _scrollTop, _onScroll, _scrollCacheFunc, _horizontal, _vertical, _getTarget, _getScrollFunc, _getVelocityProp, _getEvent, _getAbsoluteMax, _setScrollTrigger, _initCore3, Observer;
    ...
    ScrollTrigger2 = /* @__PURE__ */ function() {
      ...
      _proto.init = function init5(vars, animation) {
        ...
        if (pin) {
          ...
          pinSetter = gsap4.quickSetter(pin, direction2.a, _px);
        ...
        if (markers) {
          ...
          containerAnimation && (caMarkerSetter = gsap4.quickSetter([markerStart, markerEnd], direction2.a, _px));
          if (!useFixedPosition && !(_proxies.length && _getProxyProp(scroller, "fixedMarkers") === true)) {
            _makePositionable(isViewport ? _body2 : scroller);
            gsap4.set([markerStartTrigger, markerEndTrigger], {
              force3D: true
            });
            markerStartSetter = gsap4.quickSetter(markerStartTrigger, direction2.a, _px);
            markerEndSetter = gsap4.quickSetter(markerEndTrigger, direction2.a, _px);
          }
        }
      ...
      ScrollTrigger3.enable = function enable() {
        ...
        if (gsap4) {
          ...
          _context2 = gsap4.core.context || _passThrough3;
          ...
          if (_body2) {
            ...
            var bodyStyle = _body2.style, border2 = bodyStyle.borderTopStyle, AnimationProto = gsap4.core.Animation.prototype, bounds, i;
    ...
    ScrollTrigger2.saveStyles = function(targets) {
      return targets ? _toArray(targets).forEach(function(target2) {
        if (target2 && target2.style) {
          ...
          _savedStyles.push(target2, target2.style.cssText, target2.getBBox && target2.getAttribute("transform"), gsap4.core.getCache(target2), _context2());
        }
      }) : _savedStyles;
    };
  ...
  "node_modules/gsap/Draggable.js"() {
    ...
    Draggable = /* @__PURE__ */ function(_EventDispatcher) {
      ...
      function Draggable2(target2, vars) {
        ...
        var type = (vars.type || "x,y").toLowerCase(), xyMode = ~type.indexOf("x") || ~type.indexOf("y"), rotationMode = type.indexOf("rotation") !== -1, xProp = rotationMode ? "rotation" : xyMode ? "x" : "left", yProp = xyMode ? "y" : "top", allowX = !!(~type.indexOf("x") || ~type.indexOf("left") || type === "scroll"), allowY = !!(~type.indexOf("y") || ~type.indexOf("top") || type === "scroll"), minimumMovement = vars.minimumMovement || 2, self = _assertThisInitialized2(_this2), triggers = _toArray2(vars.trigger || vars.handle || target2), killProps = {}, dragEndTime = 0, checkAutoScrollBounds = false, autoScrollMarginTop = vars.autoScrollMarginTop || 40, autoScrollMarginRight = vars.autoScrollMarginRight || 40, autoScrollMarginBottom = vars.autoScrollMarginBottom || 40, autoScrollMarginLeft = vars.autoScrollMarginLeft || 40, isClickable = vars.clickableTest || _isClickable, clickTime = 0, gsCache = target2._gsap || gsap5.core.getCache(target2), isFixed = _isFixed3(target2), getPropAsNum = function getPropAsNum2(property, unit) {
        ...
        _this2.startDrag = function(event, align5) {
          ...
          if (align5 && !self.hitTest(event || self.pointerEvent)) {
    ...
    _getGSAP5() && gsap5.registerPlugin(Draggable);
  }
});
...
var gsap6, _coreInitted5, _window, _docEl3, _body5, _toArray3, _config2, _windowExists9, _getGSAP7, _isString5, _isFunction7, _max, _buildGetter, _clean, _getOffset, _parseVal, _initCore7, ScrollToPlugin;
var init_ScrollToPlugin = __esm({
  "node_modules/gsap/ScrollToPlugin.js"() {
    ...
    _clean = function _clean2(value, index, target2, targets) {
      _isFunction7(value) && (value = value(index, target2, targets));
      if (typeof value !== "object") {
        ...
        var result = {}, p;
        for (p in value) {
          result[p] = p !== "onAutoKill" && _isFunction7(value[p]) ? value[p](index, target2, targets) : value[p];
        }
        return result;
      }
    };
    ...
    _initCore7 = function _initCore8() {
      gsap6 = _getGSAP7();
      if (_windowExists9() && gsap6 && document.body) {
        _window = window;
    ...
    ScrollToPlugin = {
      ...
      init: function init4(target2, value, tween, index, targets) {
        ...
        var data = this, snapType = gsap6.getProperty(target2, "scrollSnapType");
        ...
        gsap6.getProperty(target2, "scrollBehavior") === "smooth" && gsap6.set(target2, {
          scrollBehavior: "auto"
        });
...
var _gsap = {
  ...
  quickTo: function quickTo(target2, property, vars) {
    var _merge22;
    var tween = gsap2.to(target2, _merge((_merge22 = {}, _merge22[property] = "+=0.1", _merge22.paused = true, _merge22), vars || {})), func = function func2(value, start, startIsRelative) {
...
Tween.version = Timeline.version = gsap2.version = "3.11.3";
_coreReady = 1;
_windowExists() && _wake();
...
function animateAbout(gsap7, screenWidths) {
  const aboutTl = gsap7.timeline({
    scrollTrigger: {
      scrub: true,
...
function animateAlbums(gsap7, container, width, screenWidths, Draggable2) {
  ...
  const albumTl = gsap7.timeline({
    scrollTrigger: {
      trigger: selectors2.container
    }
  });
  gsap7.to(selectors2.album, { x: "-200%" });
  albumTl.to(
    selectors2.album,
    {
      autoAlpha: 1,
...
function animateBgColorOnScroll(gsap7, container) {
...
function smoothScroll(scroller, ScrollTrigger3) {
...
function animateStack(gsap7) {
  const stackTl = gsap7.timeline({
    scrollTrigger: {
      scrub: true,
...
function useAnimations() {
  ...
  (0, import_react6.useEffect)(() => {
    ...
    const plugins = [ScrollTrigger3, Draggable2, ScrollToPlugin2];
...
// app/ui/components/Layout/index.tsx
var import_jsx_dev_runtime = __toESM(require_jsx_dev_runtime());
var Layout = ({ children, animateBgColorOnScroll: animateBgColorOnScroll2, smoothScrollbar }) => {
  ...
  (0, import_react16.useEffect)(() => {
    ...
    if (scrollerRef == null ? void 0 : scrollerRef.current) {
      smoothScrollbar(scrollerRef.current);
    }
  }, [animateBgColorOnScroll2, smoothScrollbar]);
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Container, {
    position: "relative",
 ...
 * @author: Jack Doyle, jack@greensock.com
*/
//# sourceMappingURL=/build/routes/index-TO7N6CH7.js.map
