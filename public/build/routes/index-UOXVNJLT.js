...
function animateAlbums(gsap2, container, width, Draggable) {
  const screenWidths = {
    phoneOnly: width < 480,
    phoneUp: width >= 480,
    laptopUp: width >= 1024,
  ...
  const albumTl = gsap2.timeline({
    scrollTrigger: {
      trigger: selectors.container
    }
  });
  gsap2.to(selectors.album, { x: "-200%" });
  albumTl.to(
    selectors.album,
    {
      autoAlpha: 1,
...
function animateBgColorOnScroll(gsap2, container) {
  const colors3 = {
    turquoise400: "#005C65",
    yellow100: "#FFAD00",
    red100: "#FF0D00"
...
function useAnimations() {
  const ScrollTrigger = (0, import_react4.useRef)(null);
  const Draggable = (0, import_react4.useRef)(null);
  const { width } = useWindowSize();
  const [isMounted, setIsMounted] = (0, import_react4.useState)(false);
  (0, import_react4.useEffect)(() => {
    gsapWithCSS.registerPlugin(ScrollTrigger);
    gsapWithCSS.registerPlugin(Draggable);
    const plugins = [ScrollTrigger, Draggable];
 ...
 * @author: Jack Doyle, jack@greensock.com
*/
//# sourceMappingURL=/build/routes/index-UOXVNJLT.js.map
