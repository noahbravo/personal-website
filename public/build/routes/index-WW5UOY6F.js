...
var init_gsap_core = __esm({
  "node_modules/gsap/gsap-core.js"() {
    ...
    wrap2 = function wrap3(min, max, value) {
      var range = max - min;
    ...
    _createPlugin = function _createPlugin2(config4) {
...
function animateBgColorOnScroll(gsap2) {
  const colors3 = {
    turquoise400: "#005C65",
    yellow100: "#FFAD00",
    red100: "#FF0D00"
...
function useAnimations() {
  (0, import_react4.useEffect)(() => {
    const ScrollTrigger = (init_gsap(), __toCommonJS(gsap_exports)).ScrollTrigger;
    const Draggable = (init_gsap(), __toCommonJS(gsap_exports)).Draggable;
    gsapWithCSS.registerPlugin(ScrollTrigger);
    gsapWithCSS.registerPlugin(Draggable);
  }, []);
  return {
    animateBgColorOnScroll: (0, import_react4.useCallback)(
      (container) => animateBgColorOnScroll(gsapWithCSS),
      []
    )
  };
}
...
var Layout = ({ children }) => {
  ...
  const { animateBgColorOnScroll: animateBgColorOnScroll2 } = useAnimations();
 ...
 * @author: Jack Doyle, jack@greensock.com
*/
//# sourceMappingURL=/build/routes/index-WW5UOY6F.js.map
