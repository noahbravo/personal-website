...
var layout = { ...margin, ...padding, ...size, ...grid, ...flex, position };
...
function getformattedProps({ props, styleProps: styleProps7, styleAliases: styleAliases5 }) {
  const stylePropsKeys = [...styleProps7 ? Object.keys(styleProps7) : [], ...Object.keys(layout)];
  const [componentStyleProps, restProps] = splitProps(props, stylePropsKeys);
  const mediaStyles = getMediaStyles(componentStyleProps, styleProps7, styleAliases5);
...
var customStyleProps = positionOptions;
var styleProps = {
  display,
  bgColor,
  position,
...
var Link = ({ children, css, isExternal = true, ...props }) => {
  const { mediaStyles, restProps } = getformattedProps({ props, styleProps: styleProps5 });
...
var import_jsx_dev_runtime = __toESM(require_jsx_dev_runtime());
var Text = import_react3.default.forwardRef(({ as = "span", css, children, ...props }, forwardedRef) => {
...
//# sourceMappingURL=/build/routes/index-Z55GIKNI.js.map
