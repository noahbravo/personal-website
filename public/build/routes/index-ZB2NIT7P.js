...
function smoothScroll(gsap6) {
  function closeMenu2() {
    gsap6.to(".mobileMenu", { duration: 0.5, autoAlpha: 0 });
    gsap6.to(".openMenuBtn", { autoAlpha: 1 });
    gsap6.to(".closeMenuBtn", { autoAlpha: 0 });
  }
  function openMenu2() {
    gsap6.to(".mobileMenu", { duration: 0.5, autoAlpha: 1 });
    gsap6.to(".openMenuBtn", { autoAlpha: 0 });
    gsap6.to(".closeMenuBtn", { autoAlpha: 1 });
  }
  document.querySelectorAll('a[href^="#"]').forEach((link) => {
    link.addEventListener("click", (e) => {
      ...
      if (isMobile) {
        gsap6.to(".mobileMenu", { duration: 0.5, autoAlpha: 0 });
        gsap6.to(".closeMenuBtn", { display: "none" });
        gsap6.to(".openMenuBtn", { display: "block" });
      }
...
var import_jsx_dev_runtime = __toESM(require_jsx_dev_runtime());
var MenuButton = ({ display: display2, openMenu: openMenu2, closeMenu: closeMenu2 }) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(import_jsx_dev_runtime.Fragment, {
  children: [
 ...
 * @author: Jack Doyle, jack@greensock.com
*/
//# sourceMappingURL=/build/routes/index-ZB2NIT7P.js.map
