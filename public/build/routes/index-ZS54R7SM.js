...
function checkIfFirefoxOrSafari(userAgent) {
  const formatedUserAgent = userAgent.toLowerCase();
  const isFirefoxOrSafari = ["firefox", "Safari"].some(
    (browser) => formatedUserAgent.indexOf(browser) > -1
  );
...
// app/ui/components/About/index.tsx
var import_jsx_dev_runtime = __toESM(require_jsx_dev_runtime());
function About({ animateAbout: animateAbout2, createImageInteraction: createImageInteraction2 }) {
 ...
 * @author: Jack Doyle, jack@greensock.com
*/
//# sourceMappingURL=/build/routes/index-ZS54R7SM.js.map
